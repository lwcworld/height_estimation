...
class logpub():
    ...
    def log_publish(self, res_RF_floor, res_RF_obs, res_VIO_floor, meas_RF, bias_VIO_z, bias_RF, weight_RF_VIO, down_status_prob, down_status, meas_used, time_delay):
    ...
    def log_print(self, res_RF_floor, res_RF_obs, res_VIO_floor, meas_RF, bias_VIO_z, bias_RF, weight_RF_VIO, down_status_prob, down_status, meas_used, time_delay):
        print('---------')
        # residual
